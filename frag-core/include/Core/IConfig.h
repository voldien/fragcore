...
namespace fragcore {
	...
	class FVDECLSPEC IConfig : public SmartReference, public ITree<IConfig> {
	  ...
	  private: /*	Internal methods.	*/
		 ...
		 */
		virtual void setInternal(const std::string &key, const void *value, const std::type_info &type);
		 ...
		 *	\type object describing the value data type.
		 */
		virtual void getInternal(const std::string &key, void *value, const std::type_info &type) const;
