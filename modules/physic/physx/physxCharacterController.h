 ...
 *
 */
#ifndef _FRAG_CORE_PHYSX_CHARACTERCONTROLLER_H_
#define _FRAG_CORE_PHYSX_CHARACTERCONTROLLER_H_ 1
...
namespace fragcore {
	 ...
	 *
	 */
	class FVDECLSPEC PhysXCharacterController : public CharacterController {
	  private:
