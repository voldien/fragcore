 ...
 *
 */
#ifndef _FRAG_CORE_RPC_PHYSIC_INTERFACE_H_
...
namespace fragcore {
	 ...
	 *
	 */
	class FVDECLSPEC RPCPhysicInterface : public PhysicInterface { // TODO add a base object for all plugin based.
		friend class PhysicFactory;

	  public:
		RPCPhysicInterface(IConfig *config);
		virtual ~RPCPhysicInterface();
	  ...
	  protected: /*	*/
		RPCPhysicInterface(const RPCPhysicInterface &other);
