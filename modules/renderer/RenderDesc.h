...
namespace fragcore {
	...
	enum GraphicFormat {
		...
		// of signed floating-point RGB texel data. 	RGBA_BC7_SRGB	A four-component, block-compressed fvformatf where
		// each 128-bit compressed texel block encodes a 4×4 rectangle of unsigned normalized RGBA texel data with sRGB
		// nonlinear encoding applied to the RGB components. 	RGBA_BC7_UNorm	A four-component, block-compressed
		...
		// A three-component, PVRTC compressed fvformatf where each 64-bit compressed texel block encodes a 4×4 rectangle
		// of unsigned normalized RGB texel data. This format has no alpha and is considered opaque.
		...
		// four-component, PVRTC compressed fvformatf where each 64-bit compressed texel block encodes a 8×4 rectangle of
		// unsigned normalized RGBA texel data with the first 32 bits encoding alpha values followed by 32 bits encoding
		// RGB values. 	RGBA_PVRTC_4Bpp_SRGB	A four-component, PVRTC compressed fvformatf where each 64-bit compressed
		...
		// RGBA_PVRTC_4Bpp_UNorm	A four-component, PVRTC compressed fvformatf where each 64-bit compressed texel block
		// encodes a 4×4 rectangle of unsigned normalized RGBA texel data with the first 32 bits encoding alpha values
		// followed by 32 bits encoding RGB values. 	RGB_ETC_UNorm	A three-component, ETC compressed format where each
		// 64-bit compressed texel block encodes a 4×4 rectangle of unsigned normalized RGB texel data. This fvformatf
		...
		// compressed fvformatf where each 128-bit compressed texel block encodes a 4×4 rectangle of signed normalized RG
		// texel data with the first 64 bits encoding red values followed by 64 bits encoding green values.
		...
		// components. 	RGBA_ASTC4X4_UNorm	A four-component, ASTC compressed fvformatf where each 128-bit compressed
		// texel block encodes a 4×4 rectangle of unsigned normalized RGBA texel data. 	RGBA_ASTC5X5_SRGB	A
		//four-component, ASTC compressed fvformatf where each 128-bit compressed texel block encodes a 5×5 rectangle of
		...
		//four-component, ASTC compressed fvformatf where each 128-bit compressed texel block encodes a 6×6 rectangle of
		// unsigned normalized RGBA texel data. 	RGBA_ASTC8X8_SRGB	A four-component, ASTC compressed fvformatf where
		// each 128-bit compressed texel block encodes an 8×8 rectangle of unsigned normalized RGBA texel data with sRGB
		// nonlinear encoding applied to the RGB components. 	RGBA_ASTC8X8_UNorm	A four-component, ASTC compressed
		// fvformatf where each 128-bit compressed texel block encodes an 8×8 rectangle of unsigned normalized RGBA texel
		// data. 	RGBA_ASTC10X10_SRGB	A four-component, ASTC compressed fvformatf where each 128-bit compressed texel
		//block encodes a 10×10 rectangle of unsigned normalized RGBA texel data with sRGB nonlinear encoding applied to
