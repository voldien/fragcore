...
namespace fragcore {
	...
	class FVDECLSPEC RenderObject : public SmartReference {
	  ...
	  public:
		 ...
		 * @return T*
		 */
		template <class T = IRenderer> T *getRenderer() const noexcept { return static_cast<T *>(this->iRenderer); }
		 ...
		 * @return void*
		 */
		void *getObject() noexcept { return this->pdata; }
		 ...
		 * @return void*
		 */
		void *getObject() const noexcept { return this->pdata; }
