 ...
 *
 */
#ifndef _FRAG_CORE_OPENCL_COMPUTE_H_
#define _FRAG_CORE_OPENCL_COMPUTE_H_ 1
#include "../ICompute.h"
#include <opencl.h>
...
namespace fragcore {
	...
	class FVDECLSPEC CLCompute : public Module {
	  public:
		...
		CLCompute() = default;
		CLCompute(const CLCompute &other) = delete;
		CLCompute(CLCompute &&other) = delete;
		virtual ~CLCompute() = default;
