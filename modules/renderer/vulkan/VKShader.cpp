...
int Shader::getLocation(const char *cparamname) { VKShaderObject *shadobj = (VKShaderObject *)this->pdata; }

void Shader::setInt(int location, int value) { VKShaderObject *shadobj = (VKShaderObject *)this->pdata; }

void Shader::setFloat(int location, float value) { VKShaderObject *shadobj = (VKShaderObject *)this->pdata; }
...
void Shader::setMatrix4f(int location, const float *pvalue) { VKShaderObject *shadobj = (VKShaderObject *)this->pdata; }
