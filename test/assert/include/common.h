...
// extern fragcore::IRenderer *createRendererInterface(fragcore::RenderingFactory::RenderingAPI api, fragcore::IConfig*
// config); extern void deleteRenderer(fragcore::IRenderer *renderer);
