...
TEST_F(RenderingInterfaceTest, CreateInterface) {
	...
	for (; it != apis.end(); it++) {
		...
		//		IRenderer *renderer;
		//
		//		ASSERT_ANY_THROW(renderer = RenderingFactory::createRendering(0,
		//&config->getSubConfig("render-driver"))); 		ASSERT_ANY_THROW(renderer = RenderingFactory::createRendering("",
		//&config->getSubConfig("render-driver"))); 		ASSERT_NO_THROW(renderer = RenderingFactory::createRendering(api,
		//&config->getSubConfig("render-driver")));
		//
...
TEST_F(RenderingInterfaceTest, Buffer) {
	...
	for (; it != apis.end(); it++) {
		...
		const std::vector<BufferDesc::BufferHint> hints2 = {BufferDesc::eStatic, BufferDesc::eDynamic,
															BufferDesc::eStream};
		const std::vector<BufferDesc::BufferType> targets = {BufferDesc::eArray,		 BufferDesc::eElementArray,
															 BufferDesc::eUniform,		 BufferDesc::eTexture,
															 BufferDesc::eShaderStorage, BufferDesc::eTransformFeedback,
															 BufferDesc::ePixelUnpack,	 BufferDesc::ePixelPack,
															 BufferDesc::eIndirectDraw,	 BufferDesc::eIndirectDispatch};
...
TEST_F(RenderingInterfaceTest, Texture) {
	...
	for (; it != apis.end(); it++) {
		...
		const std::vector<TextureDesc::Compression> compressions = {
			TextureDesc::eNoCompression, TextureDesc::eCompression, TextureDesc::eRGTC, TextureDesc::eDXT1,
			TextureDesc::eDXT4,			 TextureDesc::eS3TC
...
TEST_F(RenderingInterfaceTest, Sampler) {
	...
	for (; it != apis.end(); it++) {
		...
		const std::vector<SamplerDesc::AddressMode> addresses = {SamplerDesc::eRepeat, SamplerDesc::eRepeatMirror,
																 SamplerDesc::eClamp, SamplerDesc::eClampBorder

		};

		const std::vector<SamplerDesc::FilterMode> filterModes = {SamplerDesc::eLinear, SamplerDesc::eNearset};
